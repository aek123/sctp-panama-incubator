...
public interface __kernel_sighandler_t {
    ...
    static NativeSymbol allocate(__kernel_sighandler_t fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(__kernel_sighandler_t.class, fi, constants$0.__kernel_sighandler_t$FUNC, "(I)V", scope);
    }
...
return (int x0) -> {
            try {
                constants$0.__kernel_sighandler_t$MH.invokeExact(symbol, x0);
            } catch (Throwable ex$) {
