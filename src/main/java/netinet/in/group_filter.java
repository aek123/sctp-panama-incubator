...
public class group_filter {
    ...
    static final VarHandle gf_interface$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("gf_interface"));
    ...
    static final VarHandle gf_fmode$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("gf_fmode"));
    ...
    static final VarHandle gf_numsrc$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("gf_numsrc"));
