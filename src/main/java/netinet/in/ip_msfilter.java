...
public class ip_msfilter {
    ...
    static final VarHandle imsf_fmode$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("imsf_fmode"));
    ...
    static final VarHandle imsf_numsrc$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("imsf_numsrc"));
