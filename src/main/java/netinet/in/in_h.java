...
public class in_h  {
    ...
    public static int ntohl ( int __netlong) {
        var mh$ = RuntimeHelper.requireNonNull(constants$5.ntohl$MH, "ntohl");
        try {
    ...
    public static short ntohs ( short __netshort) {
        var mh$ = RuntimeHelper.requireNonNull(constants$5.ntohs$MH, "ntohs");
        try {
    ...
    public static int htonl ( int __hostlong) {
        var mh$ = RuntimeHelper.requireNonNull(constants$5.htonl$MH, "htonl");
        try {
    ...
    public static short htons ( short __hostshort) {
        var mh$ = RuntimeHelper.requireNonNull(constants$5.htons$MH, "htons");
        try {
    ...
    public static int bindresvport ( int __sockfd,  Addressable __sock_in) {
        var mh$ = RuntimeHelper.requireNonNull(constants$6.bindresvport$MH, "bindresvport");
        try {
    ...
    public static int bindresvport6 ( int __sockfd,  Addressable __sock_in) {
        var mh$ = RuntimeHelper.requireNonNull(constants$6.bindresvport6$MH, "bindresvport6");
        try {
            return (int)mh$.invokeExact(__sockfd, __sock_in);
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static MemorySegment __FD_ZERO_STOS() {
        return constants$6.__FD_ZERO_STOS$SEGMENT;
    }
